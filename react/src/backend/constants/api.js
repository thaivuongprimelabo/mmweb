import * as Constants from './commons';

export const API_VERSION = '/api/v1';
export const API_LOAD_TEXT = Constants.HOST + API_VERSION + '/load-text';
export const API_LOAD_TYPES = Constants.HOST + API_VERSION + '/load-types';
export const API_LOAD_LOCATIONS = Constants.HOST + API_VERSION + '/load-locations';
